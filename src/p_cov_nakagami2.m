...
%     for N  = N_vec
        ...
        I_b_1_g1 =  vpaintegral( (1 - S_b_1_g1).*x, x, [0 Inf]); % [OK]
        I_b_1_g0 =  vpaintegral( (1 - S_b_1_g0).*x, x, [0 Inf]); % [OK]
        
        I_b_2_g1 =  vpaintegral( (1 - S_b_2_g1).*x, x, [0 Inf]); % [OK]
        I_b_2_g0 =  vpaintegral( (1 - S_b_2_g0).*x, x, [0 Inf]); % [OK]
        
        I_b_3_g1 =  vpaintegral( (1 - S_b_3_g1).*x, x, [0 Inf]); % [OK]
        I_b_3_g0 =  vpaintegral( (1 - S_b_3_g0).*x, x, [0 Inf]); % [OK]
