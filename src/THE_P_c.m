...
%         lambda_b_tilde = lambda_b;
        ...
        I_b_1_g1 =  vpaintegral( (1 - S_b_1_g1).*x, x, [R_b Inf]); % [OK]
        I_b_1_g0 =  vpaintegral( (1 - S_b_1_g0).*x, x, [R_b Inf]); % [OK]
        
        I_b_2_g1 =  vpaintegral( (1 - S_b_2_g1).*x, x, [R_b Inf]); % [OK]
        I_b_2_g0 =  vpaintegral( (1 - S_b_2_g0).*x, x, [R_b Inf]); % [OK]
        
        I_b_3_g1 =  vpaintegral( (1 - S_b_3_g1).*x, x, [R_b Inf]); % [OK]
        I_b_3_g0 =  vpaintegral( (1 - S_b_3_g0).*x, x, [R_b Inf]); % [OK]
        ...
        %% Save P_c_vec
        csvwrite('D:\Satellites\28GHz\data\coverage\P_c_'...
            +string(int32(h*1e-3))+'_'+string(N) ...
            +'_'+string(R_s) + '_'+string(R_b) +'.csv', P_c_vec);
